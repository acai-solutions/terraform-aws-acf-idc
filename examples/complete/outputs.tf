...
output "test_success_1" {
  value = module.aws_identity_center.permission_sets.Platform_ViewOnly.arn == module.aws_identity_center.user_assignments[var.account_ids.core_logging][0].permission_set_arn
}
